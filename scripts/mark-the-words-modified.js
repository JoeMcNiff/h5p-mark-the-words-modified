 ...
 */
H5P.MarkTheWordsModified = (function ($, Question, Word, KeyboardNav, XapiGenerator) {
  /**
   * Initialize module.
   *
   * @class H5P.MarkTheWordsModified
   * @extends H5P.Question
   * @param {Object} params Behavior settings
   * @param {Number} contentId Content identification
   * @param {Object} contentData Object containing task specific content data
   *
   * @returns {Object} MarkTheWordsModified Mark the words instance
   */
  function MarkTheWordsModified(params, contentId, contentData) {
    ...
    this.initMarkTheWordsModified();
    this.XapiGenerator = new XapiGenerator(this);
  }

  MarkTheWordsModified.prototype = Object.create(H5P.EventDispatcher.prototype);
  MarkTheWordsModified.prototype.constructor = MarkTheWordsModified;

  /**
   * Initialize Mark The Words task
   */
  MarkTheWordsModified.prototype.initMarkTheWordsModified = function () {
   ...
   * @return {string}
   */
  MarkTheWordsModified.prototype.createHtmlForWords = function (nodes) {
    var self = this;
    var html = '';
   ...
   * @returns {jQuery}
   */
  MarkTheWordsModified.prototype.escapeHTML = function (html) {
   ...
   * @returns {Array}
   */
  MarkTheWordsModified.prototype.getIndexesOfLineBreaks = function () {
   ...
   */
  MarkTheWordsModified.prototype.addTaskTo = function ($container) {
    var self = this;
    self.selectableWords = [];
    self.answers = 0;
    
    if (!(this.params.behaviour.numLines >= this.params.textField.split('\n\n').length && this.params.behaviour.numLines !== 'undefined')) {
   ...
   */
  MarkTheWordsModified.prototype.addButtons = function () {
    var self = this;
   ...
   */
  MarkTheWordsModified.prototype.toggleSelectable = function (disable) {
   ...
   * @return {Object}
   */
  MarkTheWordsModified.prototype.getXAPIData = function () {
    return {
   ...
   *
   * @fires MarkTheWordsModified#resize
   */
  MarkTheWordsModified.prototype.setAllMarks = function () {
     ...
     * Resize event
     *
     * @event MarkTheWordsModified#resize
     */
    this.trigger('resize');
  };
   ...
   * @fires MarkTheWordsModified#resize
   */
  MarkTheWordsModified.prototype.feedbackSelectedWords = function () {
    var self = this;
   ...
   */
  MarkTheWordsModified.prototype.showEvaluation = function (answers) {
    this.hideEvaluation();
   ...
   * @fires MarkTheWordsModified#resize
   */
  MarkTheWordsModified.prototype.hideEvaluation = function () {
    this.removeFeedback();
    this.trigger('resize');
  };
   ...
   * @return {Answers}
   */
  MarkTheWordsModified.prototype.calculateScore = function () {
    var self = this;
   ...
   * @fires MarkTheWordsModified#resize
   */
  MarkTheWordsModified.prototype.clearAllMarks = function () {
    this.selectableWords.forEach(function (entry) {
      entry.markClear();
    });
   ...
   */
  MarkTheWordsModified.prototype.getAnswerGiven = function () {
   ...
   */
  MarkTheWordsModified.prototype.getScore = function () {
   ...
   */
  MarkTheWordsModified.prototype.getMaxScore = function () {
    return this.answers;
  };
   ...
   * @returns {string}
   */
  MarkTheWordsModified.prototype.getTitle = function () {
   ...
   * @see {@link https://h5p.org/documentation/developers/contracts|Needed for contracts.}
   */
  MarkTheWordsModified.prototype.showSolutions = function () {
   ...
   * @see {@link https://h5p.org/documentation/developers/contracts|Needed for contracts.}
   */
  MarkTheWordsModified.prototype.resetTask = function () {
   ...
   */
  MarkTheWordsModified.prototype.getCurrentState = function () {
   ...
   */
  MarkTheWordsModified.prototype.setH5PUserState = function () {
    var self = this;
   ...
   */
  MarkTheWordsModified.prototype.registerDomElements = function () {
   ...
   * @return {jQuery}
   */
  MarkTheWordsModified.prototype.createDescriptionsDom = function () {
    var self = this;
  ...
  return MarkTheWordsModified;
}(H5P.jQuery, H5P.Question, H5P.MarkTheWordsModified.Word, H5P.KeyboardNav, H5P.MarkTheWordsModified.XapiGenerator));

/**
 * Static utility method for parsing H5P.MarkTheWordsModified content item questions
 ...
 * ]
 *
 * @param {string} question MarkTheWordsModified textField (html)
 */
H5P.MarkTheWordsModified.parseText = function (question) {
